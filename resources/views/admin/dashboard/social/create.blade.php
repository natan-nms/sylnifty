...
<body class="">
    ...
    <div class="create">
        <form enctype="multipart/form-data" action="/social" method="post" class="py-10 px-10 w-4/12">
            ...
            <input type="text" name="name" placeholder="Titulo" class="input input-bordered input-primary w-full max-w-xs" />
            <div class="label mt-10">link:</div>
            <input type="text" name="url" placeholder="http://www.redesocial.com.br" class="input input-bordered input-primary w-full max-w-xs" />
